    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="students-menu" class="collapse">
                ...
                <li>
                    <a href="javascript:void(0);" data-toggle="collapse" data-target="#Graduate students">قائمة الطلاب المحذوفين<div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div></a>
                    <ul id="Graduate students" class="collapse">
                        {{-- <li> <a href="{{route('Graduated.create')}}">{{trans('main_trans.add_Graduate')}}</a> </li> --}}
                        <li> <a href="{{route('Graduated.index')}}">الطلاب المحذوفين</a> </li>
                    </ul>
                </li>
            </ul>
        </li>
            ...
            <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                ...
                <li>
                    <a href="javascript:void(0);" data-toggle="collapse" data-target="#Courses-icon">
                        <div class="pull-left"><i class="fas fa-book-open"></i><span class="right-nav-text">الدروس</span></div>
                        <div class="pull-right"><i class="ti-plus"></i></div>
                        <div class="clearfix"></div>
                    </a>
                    <ul id="Courses-icon" class="collapse" data-parent="#sidebarnav">
                        <li> <a href="{{route('Courses.index')}}">قائمة الكورسات</a> </li>
                        <li> <a href="{{route('Lessons.index')}}">قائمة الدروس</a> </li>
                    </ul>
                </li>
