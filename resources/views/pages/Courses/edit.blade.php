                            ...
                            <form action="{{route('courses.update','test')}}" method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="Name_ar" value="{{$course->getTranslation('name','ar')}}" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="Grade_id">
                                                @foreach($grades as $grade)
                                                    <option  value="{{ $grade->id }}" {{$grade->id == $course->grade_id ? "selected":""}}>{{ $grade->Name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="Classroom_id">
                                                <option value="{{$course->classroom_id}}">{{$course->classroom->Name_Class}}</option>                                            </select>
                                        </div>
                                    </div>
                                </div><br>
