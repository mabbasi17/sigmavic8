                    ...
                    <div class="card-body">
                        <div class="accordion gray plus-icon round">
                            ...
                            @foreach ($classrooms as $classroom)
                                ...
                                <div class="acd-group">
                                    <a href="#" class="acd-heading">{{ $classroom->Name_Class }}</a>
                                    <div class="acd-des">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a href="#"
                                                                               ...
                                                                               <a href="{{route('SectionStudents.show',$list_Sections->id)}}" class="btn btn-warning btn-sm" role="button" aria-pressed="true">قائمة الطلاب</a>
                                                                                    ...
                                                                                    <form
                                                                                        ...
                                                                                        <div class="col">
                                                                                            ...
                                                                                            <select name="Grade_id"
                                                                                                ...
                                                                                                {{-- @foreach ($list_classrooms as $list_classroom)
                                                                                                    <option
                                                                                        ...
                                                                                        <div class="col">
                                                                                            <div class="form-check">
                                                                                                ...
                                                                                                <label
                                                                                                    ...
                                                                                                    for="exampleCheck1">حالة المجموعة</label><br>
